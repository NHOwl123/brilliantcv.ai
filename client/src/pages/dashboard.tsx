...
export default function Dashboard() {
  ...
  // Create demo user for Vercel deployment
  const displayUser = user || (isVercelDemo ? {
    firstName: 'Demo',
  ...
  const applicationCount = displayUser.applicationCount || 0;
    ...
    <div className="min-h-screen bg-neutral-50">
      ...
      <div className="pt-16">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-blue-100 mt-2">
                  {displayUser.subscriptionTier === 'free' ? 'Free Plan' : 
                   displayUser.subscriptionTier === 'standard' ? 'Standard Plan' : 'Premium Plan'}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {displayUser.subscriptionTier === 'free' && applicationCount >= 3 && (
